...
const GameDetails = ({
  ...
  useEffect(() => {
    ...
    if (isPlayerWon && hintsTaken === 0) {
      animationData = require("../../../assets/animations/championWinnerAnimation.json");
    } else if (isPlayerWon && pressedSolve) {
      animationData = require("../../../assets/animations/loserAnimation.json");
    } else if (isPlayerWon) {
      animationData = require("../../../assets/animations/gameWonAnimation.json");
    } else {
      animationData = require("../../../assets/animations/keepTryingAnimation.json");
    }
